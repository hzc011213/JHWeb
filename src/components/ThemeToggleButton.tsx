...
export default function ThemeToggleButton({
  ...
  return (
    <button
      ...
      className={`size-10 cursor-pointer rounded-full border border-white/25 bg-background/15 p-0 shadow-[inset_0_1px_0_rgba(255,255,255,0.45),inset_0_-1px_0_rgba(255,255,255,0.12),0_8px_24px_rgba(15,23,42,0.12)] backdrop-blur-xl backdrop-saturate-150 transition-all duration-300 active:scale-95 dark:border-white/20 dark:bg-foreground/10 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.28),inset_0_-1px_0_rgba(255,255,255,0.08),0_8px_24px_rgba(8,12,18,0.24)] ${className}`}
      onClick={toggleTheme}
      type="button"
    >
